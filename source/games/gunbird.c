...
static struct ROM_INFO rom_gunbird[] =
{
  ...
  LOAD( ROM2, "3-u71.bin", 0x10000, 0x20000, 0x2168e4ba ),
   ...
   {      "u25.bin",   0x100000, 0xef652e0c, 0, 0, 0, },
   {      "u33.bin",   0x200000, 0x54494e6b, 0, 0, 0, },
  LOAD( SMP1, "u64.bin", 0x000000, 0x080000, 0xe187ed4f ),
  LOAD( SMP2, "u56.bin", 0x000000, 0x100000, 0x9e07104d ),
   {       "u3.bin",   0x040000, 0x0905aeb2, 0, 0, 0, },
   {           NULL,          0,          0, 0, 0, 0, },
};
...
static struct ROM_INFO rom_btlkroad[] =
{
  ...
  LOAD( SMP2, "u56.bin", 0x000000, 0x100000, 0x51d73682 ),
...
static struct ROM_INFO rom_samuraia[] =
{
  ...
  LOAD( ROM2, "3-u58.bin", 0x10000, 0x20000, 0x310f5c76 ),
   ...
   {      "u34.bin",   0x100000, 0xe6a75bd8, 0, 0, 0, },
   {      "u35.bin",   0x100000, 0xc4ca0164, 0, 0, 0, },
  LOAD( SMP1, "u68.bin", 0x000000, 0x100000, 0x9a7f6c34 ),
   {      "u11.bin",   0x040000, 0x11a04d91, 0, 0, 0, },
   {           NULL,          0,          0, 0, 0, 0, },
};
...
static struct ROM_INFO rom_s1945j[] =
{
  ...
  LOAD( GFX1, "u20.bin", 0x000000, 0x200000, 0x28a27fee ),
  LOAD( GFX1, "u22.bin", 0x200000, 0x200000, 0xca152a32 ),
  LOAD( GFX1, "u21.bin", 0x400000, 0x200000, 0xc5d60ea9 ),
  LOAD( GFX1, "u23.bin", 0x600000, 0x200000, 0x48710332 ),
  LOAD( GFX2, "u34.bin", 0x000000, 0x200000, 0xaaf83e23 ),
  LOAD( SMP1, "u61.bin", 0x000000, 0x200000, 0xa839cf47 ),
  LOAD( USER1, "u1.bin", 0x000000, 0x040000, 0xdee22654 ),
  { NULL, 0, 0, 0, 0, 0 }
};
...
/* Ignored : ROM_COPY */
  ...
  LOAD( USER1, "u1.bin", 0x000000, 0x040000, 0x681d7d55 ),
  { NULL, 0, 0, 0, 0, 0 }
};
